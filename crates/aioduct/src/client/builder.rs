...
pub struct HttpEngineBuilder<R, C> {
    ...
    pub(super) message_signature: Option<crate::message_signatures::AutomaticMessageSignature>,
    pub(super) automatic_content_digest: bool,
...
impl<R, C> HttpEngineBuilder<R, C> {
    ...
    pub fn new(connector: C) -> Self {
        ...
        Self {
            ...
            automatic_content_digest: false,
            cache: None,
            hsts: None,
            h2c_probe_ttl: None,
