...
#[path = "tests_tokio/connection_coalescing.rs"]
mod connection_coalescing;
...
#[path = "tests_tokio/pooled_connection.rs"]
...
#[path = "tests_tokio/max_active_per_host.rs"]
mod max_active_per_host;
