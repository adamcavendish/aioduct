...
aioduct = { version = "0.2.4", features = ["tokio"] }

# HTTPS + JSON, tokio runtime
aioduct = { version = "0.2.4", features = ["tokio", "rustls", "rustls-ring", "json"] }
...
aioduct = { version = "0.2.4", features = ["smol"] }

# HTTPS, smol runtime
aioduct = { version = "0.2.4", features = ["smol", "rustls", "rustls-ring"] }

# HTTP only, compio runtime (experimental)
aioduct = { version = "0.2.4", features = ["compio"] }
...
aioduct = { version = "0.2.4", features = ["tokio", "rustls", "rustls-ring", "tracing", "otel"] }

# With tower integration
aioduct = { version = "0.2.4", features = ["tokio", "rustls", "rustls-ring", "tower"] }

# Hickory DNS resolver
aioduct = { version = "0.2.4", features = ["tokio", "rustls", "rustls-ring", "hickory-dns"] }

# DNS-over-HTTPS
aioduct = { version = "0.2.4", features = ["tokio", "rustls", "rustls-ring", "doh"] }

# DNS-over-TLS
aioduct = { version = "0.2.4", features = ["tokio", "rustls", "rustls-ring", "dot"] }
...
aioduct = { version = "0.2.4", features = ["wasmtime", "smol", "rustls", "rustls-ring"] }

# Wasmtime host adapter with compio + rustls/ring
aioduct = { version = "0.2.4", features = ["wasmtime", "compio", "rustls", "rustls-ring"] }
```
