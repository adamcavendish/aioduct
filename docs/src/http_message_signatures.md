...
signature to cover `content-digest` without unbounded buffering. Existing digest
fields are preserved. Bodyless responses such as `HEAD`, `204`, `205`, and `304`
are not assigned synthesized digest fields.
